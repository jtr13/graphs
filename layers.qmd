...
ggplot(df, aes(Income)) + 
  geom_density(color = data_color, linewidth = 2) + 
...
ggplot(df, aes(x = Region, y = Income)) + 
  geom_boxplot(color = data_color) + ggtitle("geom_boxplot()") + 
...
ggplot(df, aes(x = Region)) + 
  geom_bar(fill = data_color) + ggtitle("geom_bar()") + 
...
ggplot(df, aes(x = Region)) + 
  geom_bar(fill = data_color) + ggtitle("geom_col()") +
  scale_x_discrete(expand = expansion(mult = 4*m)) +
  scale_y_continuous(expand = expansion(mult = 1.5*m)) +
  theme_void(fs, base_family = "Menlo") + 
  theme(plot.title = element_text(color = "#3379be", face = "bold"))
...
ggplot(df, aes(x = Income)) +
  geom_histogram(bins = 15, color = "black", fill = data_color) +
  scale_x_continuous(expand = expansion(mult = m)) +
  scale_y_continuous(expand = expansion(mult = m)) +
...
ggplot(CO2, aes(conc)) + 
  geom_histogram(breaks = seq(0, 1000, 125), color = "black", fill = data_color) +
  ggtitle("Histogram of conc") + 
  theme_bw(16)

ggplot(CO2, aes(uptake)) + 
  geom_histogram(breaks = seq(0, 50, 5), color = "black", fill = data_color) +
